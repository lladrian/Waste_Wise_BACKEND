...
truckRoutes.get('/get_all_truck_specific_user/:user_id', TruckController.get_all_truck_specific_user);
...
truckRoutes.put('/update_truck_status/:id', TruckController.update_truck_status);
