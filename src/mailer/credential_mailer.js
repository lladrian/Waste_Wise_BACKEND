...
const sendEmail = async (email, data) => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: `🌱 Welcome to WasteWise! Your Smart Waste Management Account`,
    html: `
     <!DOCTYPE html>
      <html>
      <head>
      ...
      <body style="font-family: 'Poppins', Arial, sans-serif; margin: 0; padding: 0; background-color: #f6f9fc;">
                 ...
                 <div style="background: #f8fbff; border-radius: 12px; padding: 25px; margin: 25px 0; border-left: 4px solid #3b82f6;">
                    ...
                    <div style="display: grid; gap: 15px;">
                        ...
                        <div style="border-bottom: 1px solid #e0f2fe; padding-bottom: 8px;">
                            ...
                            <div style="color: #1e40af; font-weight: 600;">${data.gender}</div>
                        </div>
                        <div style="border-bottom: 1px solid #e0f2fe; padding-bottom: 8px;">
                            <div style="color: #475569; font-weight: 500; margin-bottom: 4px;">Role:</div>
                            <div style="color: #1d4ed8; font-weight: 600; background: #dbeafe; padding: 4px 12px; border-radius: 20px; font-size: 14px; display: inline-block;">${data.role}</div>
                        </div>
                        ...
                        <!-- Password Section with Copy Feature -->
                        <div style="background: #eff6ff; border-radius: 8px; padding: 15px; margin: 10px 0; border: 1px solid #60a5fa;">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div style="flex: 1;">
                                    <div style="color: #475569; font-weight: 500; margin-bottom: 8px;">Temporary Password:</div>
                                    <div style="display: flex; align-items: center; gap: 10px;">
                                        <code style="background: #f1f5f9; padding: 8px 12px; border-radius: 6px; font-family: monospace; font-size: 14px; color: #dc2626; font-weight: bold; letter-spacing: 1px; flex: 1;" id="passwordText">${data.password}</code>
                                        <button onclick="copyPassword()" style="background: #3b82f6; color: white; border: none; padding: 6px 12px; border-radius: 6px; font-size: 12px; cursor: pointer; transition: background 0.3s; white-space: nowrap;">Copy</button>
                                    </div>
                                </div>
                  ...
                  <div style="background: #fff3e0; border: 1px solid #ff9800; border-radius: 8px; padding: 15px; margin: 20px 0;">
                      <div style="display: flex; align-items: flex-start;">
                          <span style="color: #ff9800; font-size: 18px; margin-right: 10px;">⚠️</span>
                          <div>
                              <strong style="color: #e65100;">Security Notice:</strong>
                  ...
                  <!-- Next Steps -->
                    <div style="text-align: center; margin: 30px 0 20px;">
                        <a href="#" style="background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%); color: white; padding: 14px 32px; text-decoration: none; border-radius: 25px; font-weight: 500; display: inline-block; box-shadow: 0 4px 15px rgba(59, 130, 246, 0.3);">
